...
public class NewLead extends AppCompatActivity implements View.OnClickListener {
    ...
    public void homeBt_newlead(View v)
    {
        onBackPressed();
    }
    ...
    public void onBackPressed() {
        if (include1.getVisibility() == View.VISIBLE) {
            ...
            this.finish();
        } else if (include4.getVisibility() == View.VISIBLE) {
            include1.setVisibility(View.GONE);
            include2.setVisibility(View.GONE);
            include3.setVisibility(View.VISIBLE);
            include4.setVisibility(View.GONE);
        ...
        } else if (include3.getVisibility() == View.VISIBLE) {
            include1.setVisibility(View.GONE);
            include2.setVisibility(View.VISIBLE);
            include3.setVisibility(View.GONE);
            include4.setVisibility(View.GONE);

        } else if (include2.getVisibility() == View.VISIBLE) {
